...
pub struct TransactionResponse {
    #[prost(string, tag = "1")]
    pub transaction_json: ::prost::alloc::string::String,
    #[prost(uint64, tag = "2")]
    pub timestamp: u64,
}
...
pub mod transaction_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_transactions(
            &mut self,
            request: impl tonic::IntoRequest<super::StreamTransactionsRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/transaction.TransactionService/StreamTransactions",
            );
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/transaction.TransactionService/StreamTransactions" => {
                    ...
                    struct StreamTransactionsSvc<T: TransactionService>(pub Arc<T>);
                    impl<
                        T: TransactionService,
                    ...
                    > for StreamTransactionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TransactionService>::stream_transactions(
                                        &inner,
                                        request,
                                    )
                                    .await
